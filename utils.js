...
exports.encrypt = function(pubkey, requestData) {
  let ciphertext = crypto.publicEncrypt(pubkey,requestData);
  return ciphertext;
};

exports.decrypt = function (privkey, ciphertext) {
  let requestData = crypto.privateDecrypt(privkey,ciphertext);
  return requestData;
};
